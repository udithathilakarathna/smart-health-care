...
class UpcomingPatientsScreen extends StatelessWidget {
  const UpcomingPatientsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Upcoming Patients'),
      ),
          ...
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              appointments.sort((first, second) {
                final firstDate =
                    appointmentDateTime(first.data()) ?? DateTime(2100);
                final secondDate =
                    appointmentDateTime(second.data()) ?? DateTime(2100);
                return firstDate.compareTo(secondDate);
              });

              if (appointments.isEmpty) {
                return const Center(child: Text('No upcoming patients found'));
              }
